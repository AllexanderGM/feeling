package com.feeling.packages.location.application;

import com.feeling.packages.location.domain.dto.CityResponseDTO;
import com.feeling.packages.location.domain.dto.CountryResponseDTO;
import com.feeling.packages.location.domain.dto.GeographicDataResponseDTO;
import com.feeling.packages.location.domain.dto.LocalityResponseDTO;
import com.feeling.packages.location.domain.services.LocationService;
...
public class LocationController {
    ...
    public ResponseEntity<List<CityResponseDTO>> getCitiesByCountry(
        ...
        List<CityResponseDTO> cities = locationService.getCitiesByCountry(countryName);
    ...
    public ResponseEntity<List<LocalityResponseDTO>> getLocalitiesByCity(
        ...
        List<LocalityResponseDTO> localities = locationService.getLocalitiesByCity(cityName);
    ...
    public ResponseEntity<GeographicDataResponseDTO> getAllGeographicData() {
        GeographicDataResponseDTO data = locationService.getAllGeographicData();
