 ...
 * @since 1.0
 */
public record UserAnalyticsOverviewDTO(
    UserStatusCountsDTO userTabsCount,
    UserEngagementMetricsDTO engagementStats,
    UserGrowthMetricsDTO growthStats,
    UserLocationDistributionDTO geographicDistribution
) {
}
