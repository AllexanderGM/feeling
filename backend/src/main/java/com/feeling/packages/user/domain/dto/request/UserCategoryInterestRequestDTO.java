 ...
 *
 * @param categoryInterestEnum Identificador único de la categoría (ESSENCE, ROUSE, SPIRIT)
 ...
 */
public record UserCategoryInterestRequestDTO(
    ...
    @Size(max = 2000, message = "La descripción extendida no puede superar 2000 caracteres")
     ...
     */
    public UserCategoryInterestRequestDTO {
        name = name != null ? name.trim() : null;
        categoryInterestEnum = categoryInterestEnum != null ? categoryInterestEnum.trim() : null;
