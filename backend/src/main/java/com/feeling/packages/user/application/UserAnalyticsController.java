...
import com.feeling.packages.user.domain.dto.AnalyticsOverviewDTO;
import com.feeling.packages.user.domain.dto.TopUsersDTO;
import com.feeling.packages.user.domain.dto.UserMetricsDTO;
...
public class UserAnalyticsController {
    ...
    public ResponseEntity<AnalyticsOverviewDTO> getAnalyticsOverview() {
        try {
            AnalyticsOverviewDTO analytics = userService.getAnalyticsOverview();
    ...
    public ResponseEntity<TopUsersDTO> getTopUsers(
            @RequestParam(defaultValue = "10") int limit) {
        try {
            TopUsersDTO topUsers = userService.getTopUsers(limit);
