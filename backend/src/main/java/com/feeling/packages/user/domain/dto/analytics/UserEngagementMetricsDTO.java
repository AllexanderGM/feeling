 ...
 * @since 1.0
 */
public record UserEngagementMetricsDTO(
    Long totalUsers,
    Long verifiedUsers,
     ...
     */
    public static UserEngagementMetricsDTO from(Long totalUsers, Long verifiedUsers, Long completeProfiles) {
        if (totalUsers == null || totalUsers == 0) {
            return new UserEngagementMetricsDTO(0L, 0L, 0L, 0, 0);
        }
