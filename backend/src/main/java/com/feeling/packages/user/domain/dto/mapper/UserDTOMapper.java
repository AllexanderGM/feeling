...
public class UserDTOMapper {
    ...
    public static UserStatusDTO toUserStatusDTO(User user) {
        return new UserStatusDTO(
            ...
            user.isApproved(),
            user.getUserApprovalStatus().name(),
    ...
    /**
     * Convierte una entidad User a UserMetricsResponseDTO
     */
    public static UserMetricsResponseDTO toUserMetricsDTO(User user) {
    ...
    public static void applyPartialUpdate(User user, UserPartialUpdateDTO partialUpdate,
        ...
        partialUpdate.imageUrls().ifPresent(user::setImages);
