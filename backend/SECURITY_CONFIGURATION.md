...
La configuración de seguridad implementada proporciona un control granular de acceso con múltiples niveles de
autorización:
...
- `GET /auth/complaintStatus/**` - Estado de usuario
...
Esta configuración proporciona un sistema de seguridad robusto, granular y escalable que protege adecuadamente todos los
recursos mientras mantiene la flexibilidad necesaria para el crecimiento de la aplicación.
