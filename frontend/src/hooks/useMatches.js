...
export const useMatches = () => {
  ...
  const fetchSentMatches = useCallback(async (page = 0, size = 10) => {
    try {
      setLoading(true)
  ...
  const fetchReceivedMatches = useCallback(async (page = 0, size = 10) => {
    try {
      setLoading(true)
  ...
  const fetchAcceptedMatches = useCallback(async (page = 0, size = 10) => {
    try {
      setLoading(true)
  ...
  const fetchFavorites = useCallback(async (page = 0, size = 10) => {
    try {
      setLoading(true)
  ...
  const sendMatch = useCallback(async (targetUserId) => {
    try {
      setLoading(true)
  ...
  const getMatchContact = useCallback(async (matchId) => {
    try {
  ...
  const addToFavorites = useCallback(async (userId) => {
    try {
      setLoading(true)
  ...
  const removeFromFavorites = useCallback(async (userId) => {
    try {
      setLoading(true)
