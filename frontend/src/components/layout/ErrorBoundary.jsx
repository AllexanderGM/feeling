...
export class ErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    Logger.error('Error capturado por Error Boundary', Logger.CATEGORIES.SYSTEM, {
    ...
    try {
      ...
      Logger.warn('No se pudo usar ErrorContext desde ErrorBoundary', Logger.CATEGORIES.SYSTEM, { contextError: contextError.message })
    }
  }
  ...
  logErrorToService = (error, errorInfo) => {
    try {
      ...
      Logger.debug('Error data preparado para servicio de logging', Logger.CATEGORIES.SYSTEM, { errorData })
    } catch (loggingError) {
      Logger.error('Error al enviar log al servicio', Logger.CATEGORIES.SYSTEM, { loggingError: loggingError.message })
    }
  }
