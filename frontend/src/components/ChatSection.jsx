...
const ChatSection = ({ chatData, onBack, getCategoryIcon }) => {
  ...
  const handleMuteChat = () => {
    Logger.info('Silenciando chat', Logger.CATEGORIES.USER, { userName: chatData.name, chatId: chatData.id })
  }

  const handleBlockUser = () => {
    Logger.warn('Bloqueando usuario', Logger.CATEGORIES.USER, { userName: chatData.name, userId: chatData.id })
  }

  const handleReportUser = () => {
    Logger.warn('Reportando usuario', Logger.CATEGORIES.USER, { userName: chatData.name, userId: chatData.id })
  }

  const handleVideoCall = () => {
    Logger.info('Iniciando videollamada', Logger.CATEGORIES.USER, { targetUser: chatData.name, targetUserId: chatData.id })
  }

  const handleVoiceCall = () => {
    Logger.info('Iniciando llamada de voz', Logger.CATEGORIES.USER, { targetUser: chatData.name, targetUserId: chatData.id })
  }
