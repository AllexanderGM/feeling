export const APP_PATHS = {
  ...
  USER: {
    ...
    EVENT_CHECKOUT: '/events/:eventId/checkout',
    EVENT_PAYMENT: '/events/:eventId/payment',
    EVENT_PAYMENT_SUCCESS: '/events/payment/success',
    EVENT_PAYMENT_ERROR: '/events/payment/error',
