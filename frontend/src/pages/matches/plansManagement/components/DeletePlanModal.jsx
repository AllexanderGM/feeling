      ...
      <ModalContent>
            ...
            <div className="flex items-start gap-3 p-4 bg-red-500/10 border border-red-500/30 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-red-300 mt-1">
                  Al eliminar este plan de match:
                </p>
              ...
              <div className="flex items-start gap-3 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-300 mt-1">
                    Este plan ha generado <strong>{plan.totalPurchases} compras</strong> y{' '}
                    <strong>${plan.revenue.toFixed(2)} USD</strong> en ingresos.
                  </p>
                  <p className="text-sm text-yellow-200 mt-2">
                    Considera desactivarlo en lugar de eliminarlo para conservar el historial.
                  </p>
                </div>
              </div>
            )}
        ...
        <ModalFooter>
          ...
          <Button
            ...
            onPress={onConfirm}
            isLoading={loading}
            startContent={!loading && <AlertTriangle className="w-4 h-4" />}
          >
            Eliminar Plan
          </Button>
        </ModalFooter>
