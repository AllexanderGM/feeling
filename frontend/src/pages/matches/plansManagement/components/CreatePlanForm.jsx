...
import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, Input, Textarea, Switch, Card, CardBody } from '@heroui/react'
import { Package, DollarSign, Hash, FileText } from 'lucide-react'

const CreatePlanForm = ({ isOpen, onClose, onSubmit, loading }) => {
      ...
      <ModalContent>
        <ModalHeader className='flex flex-col gap-1 text-gray-100'>
          <div className='flex items-center gap-3'>
            ...
            <div>
              <h2 className='text-xl font-bold'>Crear Plan de Match</h2>
              <p className='text-sm text-gray-400 font-normal'>Configura un nuevo plan de match para los usuarios</p>
            </div>
          </div>
        </ModalHeader>
                ...
                <CardBody>
                  ...
                  <div className='bg-gray-800/50 rounded-lg p-4 border border-gray-600/30'>
                    <div className='flex items-start justify-between'>
                      <div>
                        <h4 className='font-bold text-gray-100'>{formData.name || 'Nombre del Plan'}</h4>
                        <p className='text-sm text-gray-400 mt-1'>{formData.description || 'Descripción del plan'}</p>
                        {formData.attempts && (
