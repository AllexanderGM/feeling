  ...
  const renderActiveSection = () => {
    ...
    switch (activeSection) {
      case 'new':
        return (
          <NewMatchesSection 
            matches={matchesData.newMatches}
      ...
      case 'history':
        return (
          <MatchHistorySection 
            history={matchesData.matchHistory}
            searchTerm={searchTerm}
            getCategoryIcon={getCategoryIcon}
          />
        )
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3">
                ...
                <p className="text-blue-200 text-xs">
                  Envía mensajes personalizados basados en sus intereses y perfil
                </p>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-3">
                ...
                <p className="text-green-200 text-xs">
                  Actualiza tus fotos y descripción regularmente para mayor visibilidad
                </p>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-3">
                ...
                <p className="text-purple-200 text-xs">
                  Responde mensajes a tiempo y mantén conversaciones activas
                </p>
              </div>
            </div>
          </div>
