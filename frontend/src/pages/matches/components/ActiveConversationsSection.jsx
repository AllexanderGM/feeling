...
const ActiveConversationsSection = ({ conversations, searchTerm, onSelectChat, getCategoryIcon }) => {
  ...
  const handleArchiveConversation = (e, convId) => {
    e.stopPropagation()
    Logger.info('Archivar conversación', { conversationId: convId }, { category: Logger.CATEGORIES.UI })
  }
  ...
  const handlePinConversation = (e, convId) => {
    e.stopPropagation()
    Logger.info('Fijar conversación', { conversationId: convId }, { category: Logger.CATEGORIES.UI })
  }
