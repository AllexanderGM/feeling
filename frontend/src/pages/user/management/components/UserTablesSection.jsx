...
import AdminUserModals from './AdminUserModals.jsx'
...
const UserTablesSection = memo(() => {
  ...
  const handleOpenApproveModal = useCallback(user => {
    setSelectedAdminUser(user)
    setIsApproveModalOpen(true)
  }, [])

  const handleOpenReactivateModal = useCallback(user => {
    setSelectedAdminUser(user)
        ...
        case 'pending':
          return [
            ...
            approveAction({
              ...
              onClick: item => handleOpenApproveModal(item)
            }),
            rejectAction({
        ...
        case 'deactivated':
          return [
            ...
            activateAction({
              ...
              onClick: item => handleOpenReactivateModal(item)
            }),
            deleteAction({
              onClick: item => handleOpenDeleteModal(item)
            })
...
UserTablesSection.displayName = 'UserTablesSection'

export default UserTablesSection
