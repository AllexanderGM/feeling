        ...
        <div className="bg-gray-800/30 border border-gray-700/30 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-gray-400">
            <div className="flex items-center gap-2">
              ...
              <span>Miembro desde: <span className="text-gray-300">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Ubicación: <span className="text-gray-300">{user?.city}, {user?.country}</span></span>
            </div>

            <div className="flex items-center gap-2">
              <User className="w-3 h-3" />
              <span>ID de usuario: <span className="text-gray-300 font-mono">{user?.id}</span></span>
            </div>
