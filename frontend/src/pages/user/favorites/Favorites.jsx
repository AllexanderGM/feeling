...
import { Card, CardBody, Avatar, Button, Chip, Input, Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, useDisclosure } from '@heroui/react'
import {
  Heart,
  HeartOff,
  MessageCircle,
...
const Favorites = () => {
  ...
  const handleRemoveFromFavorites = (profileId) => {
    console.log('Eliminar de favoritos:', profileId)
  }
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-green-400">
                {favoritesData.filter(f => f.isOnline).length}
              </div>
              <div className="text-xs text-gray-400">En línea</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-400">
                {favoritesData.filter(f => f.hasMessage).length}
              </div>
            ...
            <div className="text-center py-12">
              {searchTerm || filterCategory !== 'all' ? (
                ...
                <>
                  ...
                  <p className="text-gray-500 mb-4">
                    Guarda perfiles que te interesen para encontrarlos fácilmente aquí
                  </p>
                  <Button
                    color="primary"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="bg-pink-500/10 border border-pink-500/20 rounded-lg p-3">
                ...
                <p className="text-pink-200 text-xs">
                  Envía mensajes regulares a tus perfiles favoritos para mantener la conexión
                </p>
              </div>
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-3">
                <Eye className="w-4 h-4 text-purple-400 mx-auto mb-2" />
                <p className="text-purple-200 text-xs">
                  Revisa regularmente si han actualizado sus perfiles o agregado nuevas fotos
                </p>
              </div>
              <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
                <Heart className="w-4 h-4 text-red-400 mx-auto mb-2" />
                <p className="text-red-200 text-xs">
                  Organiza tus favoritos por categorías para encontrar mejor compatibilidad
                </p>
              </div>
            </div>
          </div>
