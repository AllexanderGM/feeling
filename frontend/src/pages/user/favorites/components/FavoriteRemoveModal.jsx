...
/**
 * Modal de confirmación cuando se elimina un usuario de favoritos
 */
const FavoriteRemoveModal = ({ isOpen, userName, userImage, onConfirm, onOpenChange }) => {
  return (
    <Modal
      classNames={{
        ...
        {onClose => (
          <>
            <ModalHeader className='flex flex-col items-center gap-3 pt-6'>
              ...
              <div className='relative'>
                ...
                <div className='absolute -bottom-1 -right-1 w-8 h-8 bg-gradient-to-br from-gray-700 to-gray-800 rounded-full flex items-center justify-center border-3 border-gray-900 shadow-lg'>
                  <Trash2 className='w-4 h-4 text-gray-300' strokeWidth={2.5} />
                </div>
              </div>
              {/* Título y subtítulo */}
              <div className='text-center'>
                <h3 className='text-xl font-bold text-white mb-1'>¿Eliminar de favoritos?</h3>
            ...
            <ModalBody>
              <div className='text-center space-y-2'>
                <p className='text-gray-300 text-sm'>
                  <span className='font-semibold text-white'>{userName}</span> será removido de tu lista de favoritos, pero podrás agregarlo
            ...
            <ModalFooter className='justify-center gap-3 pb-6'>
              ...
              <Button
                className='bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 text-white font-semibold min-w-[140px]'
                radius='full'
                startContent={<Trash2 className='w-4 h-4' strokeWidth={2.5} />}
                onPress={() => {
                  try {
                    onConfirm()
                  } finally {
