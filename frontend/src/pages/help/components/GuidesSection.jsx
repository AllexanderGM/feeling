      ...
      steps: [
        {
          ...
          details:
            'Una buena descripción debe ser auténtica, positiva y mostrar tu personalidad. Evita información muy personal como números de teléfono o direcciones.'
        },
        {
      ...
      steps: [
        {
          ...
          details:
            'Lee su perfil completamente, encuentra puntos en común y haz una pregunta específica o comenta algo que te llamó la atención.'
        },
        {
        ...
        },
        {
          ...
          details:
            'Evita mensajes muy largos, preguntas muy personales al inicio, hablar solo de ti mismo o presionar para respuestas inmediatas.'
        }
      ]
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          details:
            'Incluye: foto de rostro, cuerpo completo, haciendo actividades que disfrutas, con amigos (sin exagerar) y en diferentes contextos.'
        },
        {
  ...
  const filteredGuides = useMemo(() => {
    ...
    return guides.filter(
      guide =>
        ...
        guide.steps.some(step => step.title.toLowerCase().includes(searchLower) || step.description.toLowerCase().includes(searchLower))
    )
  }, [currentSearchTerm])
      ...
      <div className='space-y-6'>
        ...
        <div className='flex items-center gap-4 pb-4 border-b border-gray-700/50'>
          ...
          <div className='flex items-center gap-3'>
            <div className={`w-10 h-10 rounded-lg bg-${guide.color}-500/20 flex items-center justify-center`}>{guide.icon}</div>
            <div>
        ...
        <div className='bg-green-500/10 border border-green-500/20 rounded-lg p-4 text-center'>
          ...
          <p className='text-green-200 text-sm'>Aplica estos consejos y mejora tu experiencia en Feeling</p>
        </div>
      </div>
    )
  }
