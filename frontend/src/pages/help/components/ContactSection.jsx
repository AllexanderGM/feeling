...
const ContactSection = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Logger.error(Logger.CATEGORIES.SERVICE, 'send_contact_form', 'Error sending contact form', {
        error,
        formData: {
  ...
  if (isSubmitted) {
    return (
      <div className='text-center py-12'>
        ...
        <p className='text-gray-300 mb-4'>Hemos recibido tu consulta y nuestro equipo te responderá pronto.</p>
        <div className='bg-green-500/10 border border-green-500/20 rounded-lg p-4 max-w-md mx-auto mb-6'>
          <p className='text-green-200 text-sm'>Recibirás una respuesta en tu email dentro de las próximas 24-48 horas.</p>
        </div>
