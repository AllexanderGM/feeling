    ...
    <LiteContainer className='gap-6' ariaLabel='Página de ayuda y soporte'>
      ...
      <div className='w-full bg-gradient-to-br from-blue-900/20 via-blue-800/10 to-purple-900/20 backdrop-blur-sm rounded-xl border border-blue-700/50 p-6'>
        <div className='text-center'>
          ...
          <h1 className='text-2xl sm:text-3xl font-bold text-gray-100 mb-2'>Centro de Ayuda</h1>
        ...
        <CardBody className='p-4 sm:p-6'>
          <div className='text-center space-y-4'>
            ...
            <div className='flex flex-col sm:flex-row gap-3 justify-center pt-4'>
              <Button color='primary' startContent={<Mail className='w-4 h-4' />} onPress={() => setActiveSection('contact')}>
                Contactar Soporte
              </Button>
              <Button
                variant='bordered'
