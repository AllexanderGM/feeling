...
const categoryButtons = [
    ...
    id: 'rouse', 
    label: 'Rouse', 
    className: 'bg-[#18181B] text-[#ff0062] shadow-[0_0_20px_rgba(255,0,98,0.3)] hover:shadow-[0_0_30px_rgba(255,0,98,0.5)]' 
    }
]
...
return (
    <BackgroundEffect>
    <div className={`w-full max-w-3xl lg:max-w-6xl xl:max-w-7xl mx-auto px-6 py-8 transition-all duration-700 ease-out transform ${animateIn ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
        ...
        <div className="lg:max-w-md mx-auto">
            ...
            <Radio value="hombre" className="text-white">Hombre</Radio>
            <Radio value="mujer" className="text-white">Mujer</Radio>
            <Radio value="gay" className="text-white">Gay</Radio>
            </RadioGroup>
        </div>
        ...
        <div className="text-center pt-6">
            ...
            color="default"
            size="lg"
            className="w-full max-w-md transition-all duration-300 hover:scale-105"
            >
            Crear perfil
            </Button>
        </div>
