...
const UserTableTest = memo(() => {
  ...
  const renderUserTable = useCallback(
    userType => {
      ...
      Logger.debug(`Rendering table for user type: ${userType}`, { category: Logger.CATEGORIES.USER })
  ...
  return (
    <div className='p-6'>
      ...
      {isDeleteModalOpen && selectedUser && (
        <DeleteUserModal isOpen={isDeleteModalOpen} user={selectedUser} onClose={handleCloseModals} onSuccess={handleOperationSuccess} />
      )}
