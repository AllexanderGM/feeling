...
const Home = () => {
  ...
  return (
    <div className='flex flex-col relative pt-0 md:pt-0'>
      ...
      <Header activeFiltersCount={activeFiltersCount} user={user} onOpenFilters={onFiltersOpen} onRefresh={resetStack} />
...
const EmptyState = ({ removedCards, activeFiltersCount, onResetStack, onOpenFilters }) => (
  <div className='text-center max-w-sm mx-auto'>
    ...
    <div className='space-y-3'>
      ...
      <Button className='w-full text-gray-400' startContent={<Filter className='w-4 h-4' />} variant='light' onPress={onOpenFilters}>
        Filtros Avanzados
