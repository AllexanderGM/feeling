              ...
              <CardBody className='p-6'>
                <div className='flex items-center justify-between mb-4'>
                  ...
                  <div className='text-right'>
                    <h3 className='text-2xl font-bold text-default-800'>{stat.value}</h3>
                  </div>
                </div>
                <div>
                  <h4 className='text-sm font-semibold text-default-600 mb-1'>{stat.title}</h4>
                  <p className='text-xs text-default-500 mb-2'>{stat.description}</p>
        ...
        <Card className='bg-default-50 border border-default-200'>
          <CardBody className='p-6'>
            <div className='flex items-center gap-3 mb-6'>
              ...
              <div>
                <h3 className='text-lg font-semibold text-default-800'>Destinos Populares</h3>
                <p className='text-sm text-default-500'>Ciudades con más eventos</p>
              </div>
            </div>
            ...
            <div className='space-y-4'>
              {popularDestinations.length > 0 ? (
                popularDestinations.map((destination, index) => (
                  <div key={index} className='flex items-center justify-between'>
                    <div className='flex items-center gap-3'>
                      ...
                      <div>
                        <p className='text-sm font-medium text-default-800'>{destination.city}</p>
                ...
                <p className='text-sm text-default-500 text-center py-4'>No hay datos de destinos disponibles</p>
              )}
            </div>
          </CardBody>
        </Card>
        ...
        <Card className='bg-default-50 border border-default-200'>
          <CardBody className='p-6'>
            <div className='flex items-center gap-3 mb-6'>
              ...
              <div>
                <h3 className='text-lg font-semibold text-default-800'>Métricas de Rendimiento</h3>
                <p className='text-sm text-default-500'>Indicadores clave del sistema</p>
              </div>
            </div>
            ...
            <div className='space-y-6'>
              ...
              <div>
                <div className='flex items-center justify-between mb-2'>
                  <p className='text-sm font-medium text-default-700'>Eventos Pendientes</p>
              ...
              <div className='pt-4 border-t border-default-200'>
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-2'>
                    ...
                    <p className='text-sm font-medium text-default-700'>Precio Promedio</p>
                  </div>
                  <span className='text-lg font-bold text-default-800'>${averagePrice.toLocaleString()}</span>
                </div>
                <p className='text-xs text-default-500 mt-1'>Por evento en el sistema</p>
              </div>
            </div>
          </CardBody>
        </Card>
